...
import { filterLinkOccurrences, findLinksByAuthor, findLinksByDomain, findLinksByTopic, fetchLinks, insertNewLinks, networkTopTen, } from "@sill/links";
...
const links = new Hono()
    ...
    try {
        const filteredMetadata = Object.fromEntries(Object.entries(metadata).filter(([, value]) => value !== null));
