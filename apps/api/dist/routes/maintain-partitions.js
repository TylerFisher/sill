...
import { archivePartitionToR2, dropPartition, getPartitionNameForDate, } from "../utils/partition-archive.server";
const app = new Hono();
app.get("/", async (c) => {
    ...
    try {
        ...
        if (archiveResult.success) {
            ...
            console.warn(`Archive failed for ${partitionName}, keeping partition:`, archiveResult.error);
        }
    }
    catch (error) {
