...
const scrobbleToLinkPost = (share: ShareRow, base: LinkPost): LinkPost => {
 ...
 * - `app.rocksky.scrobble`: a music listen, rendered as a compact track card
 *   (see `scrobbleToLinkPost`).
 *
...
export const shareRowToLinkPost = (
  ...
  if (share.collection === "app.rocksky.scrobble") {
