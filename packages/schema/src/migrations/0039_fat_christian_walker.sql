...
ALTER TABLE "link" ADD COLUMN "metadata" json;--> statement-breakpoint
ALTER TABLE "link" ADD COLUMN "scraped" boolean DEFAULT false;--> statement-breakpoint
CREATE MATERIALIZED VIEW "public"."network_top_ten" AS (select "link"."id", "link"."url", "link"."title", "link"."description", "link"."imageUrl", "link"."giftUrl", "link"."metadata", "link"."scraped", max("link_post_denormalized"."postDate") as "mostRecentPostDate", 
  CAST(LEAST(
